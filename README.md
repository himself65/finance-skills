...
External API data — sentiment via Adanos, fundamental research and raw data via Funda AI (MCP + REST), Fintel short-interest/ownership intelligence, Hormuz Strait monitoring, TradingView data via a bundled headless MCP server or the desktop app, and Hyperliquid perp/spot reading.
